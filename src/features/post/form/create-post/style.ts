const style = {
    ...
    fileInput: "w-54 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-color-primary file:text-white file:cursor-pointer h-10",  
    ...
    themeSelect:
      "border border-input-border rounded p-1.5 bg-input-background text-input-text focus:outline-none focus:border-input-border-active cursor-pointer",
